...
export const favicon =
  "https://pacificsmilesdental.com.au/wp-content/uploads/2022/09/cropped-psg-favicon-192x192.png";

// export const apikey_for_entity = "ea7ea73738da090eba9cafbc45220b0b"
export const apiKey = "	4b4d6f2740dfba8da69d2879d672deaf";
export const experienceKey = "pacific-smiles";
...
<path d="M877,4760h5a1,1,0,0,0,1-1v-8.59l.293.3a1,1,0,1,0,1.414-1.42l-9-9a1,1,0,0,0-1.414,0l-9,9a1,1,0,0,0,1.414,1.42l.293-.3V4759a1,1,0,0,0,1,1h5a1,1,0,0,0,1-1v-5h2v5A1,1,0,0,0,877,4760Zm4-2h-3v-5a1,1,0,0,0-1-1h-4a1,1,0,0,0-1,1v5h-3v-9.59l6-6,6,6Z" transform="translate(-865 -4739.998)" fill="#255ec1" fill-rule="evenodd"/>
</svg>`;
