...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    title:`${document.c_meta_title?document.c_meta_title:`pacific smiles dental`}`,
    charset: "UTF-8",
    ...
    tags: [
      {
        ...
        attributes: {
          name: "description",
          content: `${document.c_meta_description?document.c_meta_description:`pacific smiles dental item competitive rates.`}`,
        },
      },
      {
        type: "meta",
      ...
      },
      {
        ...
        attributes: {
          ...
          content: `${document.c_meta_description?document.c_meta_description:`pacific smiles dental.`}`,
        },
      },
      {
        type: "meta",
     ...
     },
     {
       ...
       attributes: {
         name: "twitter:title",
         content: `${document.c_meta_title?document.c_meta_title:`pacific smiles dental`}`,
       },
     },
     {
       type: "meta",
